 ...
 */
import { Scheduler } from '@carpentry/formworks/scheduler';
...
/**
 * Backward-compatible helper expected by app bootstrap.
 * Registers recurring jobs onto an existing scheduler instance.
 */
export function registerScheduledTasks(scheduler: Scheduler): void {
  scheduler
    .schedule('billing:meter-usage', async () => {
      console.log('[Scheduler] Metering API usage across all tenants');
    })
